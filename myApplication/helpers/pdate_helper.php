...
$_ENV['AboutFa'] = "برنامه‌نویس: طاها کامکار" ; 
$_ENV['AboutEn'] = "Programmer: Taha Kamkar" ; 
		...
		while($i < $lenghFormat)
		{
			$par= $format{$i};
				...
				switch($par)
				{
					...
					case 'M':
						$result.= substr($pdateMonthName[$pMonth], 0, 15);
					break;
...
//		TAHA DEVELOPMENTS (EASE OF ACCESS ONLY) STARTS FROM HERE


//=======================================================================================================
function td_pdate($format, $timestamp= '')
{
	return gPureText(pdate($format, $timestamp)) ; 
}
